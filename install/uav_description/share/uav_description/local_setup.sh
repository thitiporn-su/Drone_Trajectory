...
: ${AMENT_CURRENT_PREFIX:="/home/kaymarrr/drone_ws/install/uav_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/uav_description/environment/pythonpath.sh"
